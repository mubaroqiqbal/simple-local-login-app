          ...
          builder: (context, constraints) {
            return IntrinsicHeight(
              child: Column(
                ...
                children: [
                  _label != null ? Text(_label!, style: TextStyle(fontSize: 12)) : SizedBox.shrink(),
                  SizedBox(height: 3),
                  Stack(
                    children: <Widget>[
                      if (widget.controller?.textController == null || widget.controller?.textController.text.isEmpty == true)
                        Positioned(
                            top: _label != null
                                ? 17
                                : _focusNode.hasFocus
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          textAlignVertical: _label == null ? TextAlignVertical.center : null,
